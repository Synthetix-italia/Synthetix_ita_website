...
const data: {
	...
	{
		externalLink: 'https://mirror.xyz/synthetixitalia.eth',
		label: '🗞️ Blog Italiano',
		hideOnHeader: false,
	},
	{
		externalLink: 'https://drive.google.com/file/d/1bCLLIaoM3mteAOgnm7FMfbuPcxrmgAPg/view',
		label: '🇮🇹 Litepaper',
		hideOnHeader: false,
	},
];
