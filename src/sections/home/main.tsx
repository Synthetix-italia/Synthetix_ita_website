...
const MainSection = () => {
	...
	return (
		<MainContainer>
			<Left>
				<PageTitle>Community Italiana SNX</PageTitle>
				<SectionDescription>
					Synthetix Italia Nasce dalla passione di partecipanti alla community 
					ufficiale. 
				</SectionDescription>
				<LearnMoreButton
				...
				>
					Ma cosa ha di speciale Synthetix<ArrowDownIcon />
				</LearnMoreButton>
			</Left>
			<Right />
		</MainContainer>
